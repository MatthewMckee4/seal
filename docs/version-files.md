...
1. Be specific with search patterns - include enough context to avoid false matches
1. Test custom patterns - run `seal validate` to ensure your configuration works
1. Document custom templates - add comments in your seal.toml for complex configurations
1. Keep templates consistent - use the same template format across similar files
